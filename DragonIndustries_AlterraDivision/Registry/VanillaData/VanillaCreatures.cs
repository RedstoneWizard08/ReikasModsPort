...
public class VanillaCreatures : PrefabReference {
	...
	private static readonly Dictionary<string, VanillaCreatures> lookup = new();
	...
	public static readonly VanillaCreatures SKYRAY = new("6a1b444f-138f-46fa-88bb-d673a2ceb689");
	...
	public static readonly VanillaCreatures CUDDLEFISH = new("d4be3a5d-67c3-4345-af25-7663da2d2898");
	...
	public static readonly VanillaCreatures REEFBACK_BABY = new("34765384-821f-41ad-b716-1b68c507e4f2");
	...
	public static readonly VanillaCreatures EMPEROR_BABY = new("09883a6c-9e78-4bbf-9561-9fa6e49ce766");
	...
	private static readonly Dictionary<string, VanillaCreatures> names = new();
	...
	private static void populateNames() {
		if (names.Count == 0) {
			foreach (var f in typeof(VanillaCreatures).GetFields()) {
				if (f.IsStatic && f.FieldType == typeof(VanillaCreatures)) {
					var vf = (VanillaCreatures)f.GetValue(null);
					names[f.Name] = vf;
					vf.name = f.Name;
				}
			}
	...
	private readonly List<BiomeBase> nativeBiomes = [];
