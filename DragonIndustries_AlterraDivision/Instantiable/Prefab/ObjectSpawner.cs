...
public sealed class ObjectSpawner : CustomPrefab {
    internal static readonly Dictionary<string, SpawnSet> spawnSets = new();
    ...
    private class ObjectSpawnerTag : MonoBehaviour {
        ...
        private void Update() {
            ...
            var go = ObjectUtil.createWorldObject(spawns.spawnIDs.getRandomEntry().getPrefabID());
