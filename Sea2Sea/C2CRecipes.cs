...
public static class C2CRecipes {
	...
	internal static void addItemsAndRecipes() {
        ...
        */
		...
		C2CItems.oxygeniteCharge.addIngredient(TechType.Tank, 1).addIngredient(CustomMaterials.getItem(CustomMaterials.Materials.OXYGENITE), 4).addIngredient(TechType.AramidFibers, 1).addIngredient(TechType.Silicone, 4);
