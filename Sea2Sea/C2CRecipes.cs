...
public static class C2CRecipes {
    ...
    private static readonly List<TechType> removedVanillaUnlocks = [];
    ...
    internal static void addItemsAndRecipes() {
        ...
        var tiingot = "41919ae1-1471-4841-a524-705feb9c2d20";
        ...
        createCompressedIngot(
            CustomMaterials.getItem(CustomMaterials.Materials.PLATINUM),
            "4ae90608-40da-45ce-8480-e2f0133f96b2",
            18,
            2,
            0.25F
        );
        createCompressedIngot(
            CustomMaterials.getItem(CustomMaterials.Materials.IRIDIUM),
            "a06157cc-8de8-4fec-85a6-76b2aee1e263",
            40,
            5,
            0.8F,
            8
        ...
        TechData.GetCraftTime(TechType.Glass, out quartzIngotToGlass.craftTime);
        ...
        quartzIngotToGlass.craftingMenuTree = ["Resources", "C2CIngots2"];
        quartzIngotToGlass.sprite = SpriteManager.Get(TechType.Glass);
        quartzIngotToGlass.ownerMod = SeaToSeaMod.ModDLL;
        quartzIngotToGlass.Register();

        var acid = CraftingItems.getItem(CraftingItems.Items.WeakAcid);
        acid.craftingTime = 0.5F;
        acid.addIngredient(TechType.AcidMushroom, 4);

        var enzyT = CraftingItems.getItem(CraftingItems.Items.TreaderEnzymes);
         ...
         */
        var bacteria = CraftingItems.getItem(CraftingItems.Items.BacterialSample);
        bacteria.craftingTime = 1;
        bacteria.numberCrafted = hard ? 2 : 3;
        bacteria.addIngredient(TechType.SeaCrownSeed, 2)
            .addIngredient(enzyT, 2); //.addIngredient(TechType.TreeMushroomPiece, 1);

        var enzy = CraftingItems.getItem(CraftingItems.Items.BioEnzymes);
        enzy.craftingTime = 4;
        ...
        var comb = CraftingItems.getItem(CraftingItems.Items.HoneycombComposite);
        comb.craftingTime = 12;
        comb.addIngredient(TechType.AramidFibers, hard ? 3 : 2).addIngredient(TechType.PlasteelIngot, 1);

        var gem = CraftingItems.getItem(CraftingItems.Items.DenseAzurite);
        gem.craftingTime = 4;
        gem.addIngredient(CustomMaterials.getItem(CustomMaterials.Materials.VENT_CRYSTAL), 9)
            .addIngredient(TechType.Diamond, 1).addIngredient(TechType.Magnetite, 5);

        var lens = CraftingItems.getItem(CraftingItems.Items.CrystalLens);
        lens.craftingTime = 20;
        lens.addIngredient(gem, 5).addIngredient(TechType.TitaniumIngot, 2).addIngredient(TechType.AdvancedWiringKit, 1)
            .addIngredient(TechType.FiberMesh, 4);

        var sealedFabric = CraftingItems.getItem(CraftingItems.Items.SealFabric);
        sealedFabric.craftingTime = 4;
        sealedFabric.numberCrafted = 2;
        sealedFabric.addIngredient(CraftingItems.getItem(CraftingItems.Items.Sealant), 3)
            .addIngredient(TechType.AramidFibers, 1).addIngredient(TechType.StalkerTooth, 1)
            .addIngredient(TechType.Silicone, 2);

        var armor = CraftingItems.getItem(CraftingItems.Items.HullPlating);
        armor.craftingTime = 9;
        armor.numberCrafted = 2;
        armor.addIngredient(TechType.PlasteelIngot, 2).addIngredient(TechType.Lead, 3).addIngredient(comb, 1)
            .addIngredient(TechType.Nickel, 6).addIngredient(CraftingItems.getItem(CraftingItems.Items.Nanocarbon), 1);

        var motor = CraftingItems.getItem(CraftingItems.Items.Motor);
        motor.craftingTime = 1;
        motor.addIngredient(TechType.CopperWire, 1).addIngredient(TechType.Titanium, 2)
            .addIngredient(TechType.Lubricant, 1).addIngredient(TechType.Gold, 1);

        var traceMetal = CraftingItems.getItem(CraftingItems.Items.TraceMetals);
        ...
        drone.addIngredient(motor, 1).addIngredient(TechType.Titanium, 1).addIngredient(TechType.ComputerChip, 1)
            .addIngredient(TechType.PowerCell, 1);

        var chlorine = CraftingItems.getItem(CraftingItems.Items.Chlorine);
        ...
        var sulfurAcid = CraftingItems.getItem(CraftingItems.Items.SulfurAcid);

        var heatSeal = CraftingItems.getItem(CraftingItems.Items.HeatSealant);
        heatSeal.craftingTime = 5;
        heatSeal.numberCrafted = 1;
        heatSeal.addIngredient(sealedFabric, 1).addIngredient(sulfurAcid, 1)
            .addIngredient(CraftingItems.getItem(CraftingItems.Items.GhostGel), hard ? 3 : 2)
            .addIngredient(C2CItems.mountainGlow.seed, 3);

        var tankWall = CraftingItems.getItem(CraftingItems.Items.FuelTankWall);
        tankWall.craftingTime = 2.5F;
        tankWall.addIngredient(CustomMaterials.getItem(CustomMaterials.Materials.PRESSURE_CRYSTALS), 9)
            .addIngredient(heatSeal, 2).addIngredient(CraftingItems.getItem(CraftingItems.Items.SmartPolymer), 1);

        var microfilter = CraftingItems.getItem(CraftingItems.Items.MicroFilter);
        microfilter.craftingTime = 6F;
        microfilter.addIngredient(TechType.Titanium, 2).addIngredient(C2CItems.mountainGlow.seed, hard ? 2 : 1)
            .addIngredient(TechType.FiberMesh, 5).addIngredient(TechType.Diamond, 1)
            .addIngredient(TechType.AluminumOxide, hard ? 3 : 2);

        var fuel = CraftingItems.getItem(CraftingItems.Items.RocketFuel);
        fuel.craftingTime = 6;
        fuel.addIngredient(TechType.Sulphur, 8).addIngredient(TechType.Kyanite, hard ? 4 : 3)
            .addIngredient(TechType.CrashPowder, hard ? 3 : 2).addIngredient(TechType.PrecursorIonCrystal, hard ? 2 : 1)
            .addIngredient(microfilter, 1);

        var electro = CraftingItems.getItem(CraftingItems.Items.Electrolytes);
        electro.craftingTime = 1;
        electro.numberCrafted = 2;
        electro.addIngredient(C2CItems.sanctuaryPlant.seed, 4).addIngredient(C2CItems.brineCoralPiece, 3)
            .addIngredient(C2CItems.voltaicBladderfish, 2).addIngredient(sulfurAcid, 1);
        ...
        var dimlum = CraftingItems.getItem(CraftingItems.Items.DimLuminol);
        dimlum.craftingTime = 6F;
        dimlum.addIngredient(TechType.DisinfectedWater, 1).addIngredient(TechType.PurpleStalkSeed, 2)
            .addIngredient(TechType.EyesPlantSeed, 1).addIngredient(TechType.RedBasketPlantSeed, 1)
            .addIngredient(TechType.SnakeMushroomSpore, 2).addIngredient(TechType.RedConePlantSeed, 1);

        var obsidiglass = CraftingItems.getItem(CraftingItems.Items.ObsidianGlass);
        obsidiglass.craftingTime = 3F;
        obsidiglass.addIngredient(TechType.EnameledGlass, 1).addIngredient(TechType.Aerogel, 2)
            .addIngredient(C2CItems.getIngot(TechType.Quartz).ingot, 1)
            .addIngredient(CustomMaterials.getItem(CustomMaterials.Materials.OBSIDIAN), 3).addIngredient(
                CraftingItems.getItem(CraftingItems.Items.Tungsten),
                1
            );
        ...
        altFiberMesh.craftingMenuTree = ["Resources", "BasicMaterials"];
        ...
        altSulfurAcid = new DuplicateRecipeDelegateWithRecipe(
            CraftingItems.getItem(CraftingItems.Items.SulfurAcid),
            rec
        );
        ...
        altSulfurAcid.craftingMenuTree = ["Resources", "C2Chemistry"];
        ...
        */
        ...
        var node = RecipeUtil.getRecipeNode(TechType.HatchingEnzymes);
        CraftTreeHandler.RemoveNode(node.recipeType, node.path.Split('\\'));
        precursorEnzymeFab = EnumHandler.AddEntry<CraftTree.Type>("PrecursorEnzymes")
            .CreateCraftTreeRoot(out precursorEnzymeTree);
        ...
        RecipeUtil.setItemCategory(
            TechType.HatchingEnzymes,
            TechGroup.Resources,
            C2CItems.precursorCategory
        ); //this removes from PDA
        ...
        C2CItems.depth1300.addIngredient(TechType.VehicleHullModule3, 1)
            .addIngredient(CustomMaterials.getItem(CustomMaterials.Materials.PRESSURE_CRYSTALS), 12)
            .addIngredient(obsidiglass, 3).addIngredient(armor, 2).addIngredient(
                CraftingItems.getItem(CraftingItems.Items.Tungsten),
                8
            );
        C2CItems.powerSeal.addIngredient(TechType.Polyaniline, 3)
            .addIngredient(CustomMaterials.getItem(CustomMaterials.Materials.IRIDIUM), 6)
            .addIngredient(CraftingItems.getItem(CraftingItems.Items.Electrolytes), 2)
            .addIngredient(CraftingItems.getItem(CraftingItems.Items.Sealant), 5).addIngredient(
                CraftingItems.getItem(CraftingItems.Items.GhostGel),
                hard ? 8 : 5
            );
        C2CItems.heatSinkModule.addIngredient(CustomMaterials.getItem(CustomMaterials.Materials.IRIDIUM), 2)
            .addIngredient(TechType.Pipe, 5).addIngredient(motor, 1).addIngredient(TechType.AdvancedWiringKit, 1)
            .addIngredient(CraftingItems.getItem(CraftingItems.Items.Tungsten), 5);
        C2CItems.speedModule.addIngredient(TechType.Nickel, 5).addIngredient(motor, 4)
            .addIngredient(TechType.AdvancedWiringKit, 1).addIngredient(electro, hard ? 3 : 2)
            .addIngredient(TechType.Gravsphere, 1);
        C2CItems.lightModule.addIngredient(TechType.LEDLight, 3).addIngredient(TechType.WiringKit, 1)
            .addIngredient(TechType.CopperWire, 1).addIngredient(CraftingItems.getItem(CraftingItems.Items.Luminol), 2)
            .addIngredient(CraftingItems.getItem(CraftingItems.Items.Tungsten), 1);
        C2CItems.tetherModule.addIngredient(TechType.ExosuitPropulsionArmModule, 1).addIngredient(TechType.WiringKit, 1)
            .addIngredient(CraftingItems.getItem(CraftingItems.Items.Motor), 1);
        C2CItems.cyclopsHeat.addIngredient(TechType.CyclopsThermalReactorModule, 1)
            .addIngredient(TechType.CyclopsFireSuppressionModule, 1)
            .addIngredient(CustomMaterials.getItem(CustomMaterials.Materials.IRIDIUM), 12).addIngredient(heatSeal, 4);
        C2CItems.cyclopsStorage.addIngredient(TechType.VehicleStorageModule, 3).addIngredient(TechType.ComputerChip, 1)
            .addIngredient(CustomMaterials.getItem(CustomMaterials.Materials.PLATINUM), 1).addIngredient(
                CraftingItems.getItem(CraftingItems.Items.Nanocarbon),
                2
            );
        C2CItems.sealSuit.addIngredient(CustomMaterials.getItem(CustomMaterials.Materials.PLATINUM), 3)
            .addIngredient(sealedFabric, 5).addIngredient(TechType.Titanium, 1).addIngredient(TechType.CrashPowder, 2);
        C2CItems.t2Battery.addIngredient(TechType.Battery, 1)
            .addIngredient(CraftingItems.getItem(CraftingItems.Items.DenseAzurite), 1)
            .addIngredient(TechType.Polyaniline, 1).addIngredient(TechType.MercuryOre, 2)
            .addIngredient(TechType.Lithium, 2).addIngredient(TechType.Silicone, 1);
        C2CItems.rebreatherV2.addIngredient(CustomMaterials.getItem(CustomMaterials.Materials.PLATINUM), 4)
            .addIngredient(microfilter, 2).addIngredient(sealedFabric, 3).addIngredient(TechType.Rebreather, 1)
            .addIngredient(CraftingItems.getItem(CraftingItems.Items.Motor), 1).addIngredient(C2CItems.t2Battery, 1);
        if (hard) {
            C2CItems.rebreatherV2.addIngredient(TechType.ComputerChip, 1);
            C2CItems.rebreatherV2.addIngredient(TechType.Pipe, 5);
        }

        C2CItems.breathingFluid.addIngredient(TechType.Benzene, 1).addIngredient(SeaToSeaMod.Geogel, 4)
            .addIngredient(TechType.MembrainTreeSeed, 2).addIngredient(TechType.Eyeye, 2)
            .addIngredient(C2CItems.bkelpBumpWormItem.TechType, 1).addIngredient(TechType.OrangeMushroomSpore, 1)
            .addIngredient(TechType.SpottedLeavesPlantSeed, 2).addIngredient(
                CustomMaterials.getItem(CustomMaterials.Materials.OXYGENITE),
                2
            );
        C2CItems.liquidTank.addIngredient(TechType.HighCapacityTank, 1).addIngredient(C2CItems.breathingFluid, 1)
            .addIngredient(CraftingItems.getItem(CraftingItems.Items.HoneycombComposite), 1)
            .addIngredient(sealedFabric, 2);
        ...
        C2CItems.oxygeniteCharge.addIngredient(TechType.Tank, 1)
            .addIngredient(CustomMaterials.getItem(CustomMaterials.Materials.OXYGENITE), 4)
            .addIngredient(TechType.AramidFibers, 1).addIngredient(TechType.Silicone, 4);
        C2CItems.heatSink.addIngredient(TechType.Titanium, 4).addIngredient(TechType.Lithium, 1).addIngredient(
            CraftingItems.getItem(CraftingItems.Items.Tungsten),
            3
        );
        C2CItems.bandage.addIngredient(TechType.FirstAidKit, 1).addIngredient(SeaToSeaMod.Geogel, 1)
            .addIngredient(C2CItems.healFlower.seed, 3).addIngredient(TechType.JellyPlant, 1)
            .addIngredient(TechType.Bleach, 1);
        C2CItems.treatment.addIngredient(C2CItems.bandage, 1).addIngredient(TechType.Glass, 1)
            .addIngredient(TechType.Titanium, 1).addIngredient(
                CraftingItems.getItem(CraftingItems.Items.WeakEnzyme42),
                2
            );
        C2CItems.chargeFinRelay.addIngredient(CraftingItems.getItem(CraftingItems.Items.Electrolytes), 4)
            .addIngredient(CustomMaterials.getItem(CustomMaterials.Materials.VENT_CRYSTAL), 1)
            .addIngredient(TechType.AdvancedWiringKit, 1).addIngredient(TechType.Magnetite, 4);
        ...
        item.Patch();*/
        var t2un = new UncraftingRecipeItem(C2CItems.t2Battery) {
            craftTime = 6,
            ownerMod = SeaToSeaMod.ModDLL,
        };
        t2un.Register();
        ...
        rec.Ingredients.Insert(
            0,
            new Ingredient(CraftingItems.getItem(CraftingItems.Items.BrokenT2Battery).TechType, 1)
        );
        t2BatteryRepair = new DuplicateRecipeDelegateWithRecipe(C2CItems.t2Battery, rec);
        t2BatteryRepair.setRecipe();
        TechData.GetCraftTime(C2CItems.t2Battery.TechType, out t2BatteryRepair.craftTime);
        ...
        */
        ...
        addItemToRecipe(
            ...
            CustomMaterials.getItem(CustomMaterials.Materials.PHASE_CRYSTAL).TechType,
            6
        );
        ...
        addItemToRecipe(
            TechType.ReinforcedDiveSuit,
            CustomMaterials.getItem(CustomMaterials.Materials.PRESSURE_CRYSTALS).TechType,
            9
        );
        ...
        addItemToRecipe(TechType.WaterFiltrationSuit, C2CItems.mountainGlow.seed.TechType, 3);
        ...
        RecipeUtil.modifyIngredients(
            ...
            i => {
                if (i.techType == TechType.FiberMesh) i._amount = 2;
                return false;
            }
        );
        ...
        RecipeUtil.modifyIngredients(
            ...
            i => {
                if (i.techType == TechType.Lithium) i._amount = i.amount * 3 / 2;
                return false;
            }
        );
        ...
        RecipeUtil.modifyIngredients(
            ...
            i => {
                i._amount *= i.techType == TechType.Gold ? 5 : 2;
                return i.techType == TechType.Silver;
            }
        );
        addItemToRecipe(TechType.PrecursorIonBattery, TechType.PowerCell, 1);
        addItemToRecipe(
            TechType.PrecursorIonBattery,
            CustomMaterials.getItem(CustomMaterials.Materials.PLATINUM).TechType,
            4
        );
        ...
        RecipeUtil.modifyIngredients(
            ...
            i => {
                if (i.techType == TechType.PrecursorIonBattery) i._amount = 1;
                return i.techType == TechType.Silicone;
            }
        );
        addItemToRecipe(
            TechType.PrecursorIonPowerCell,
            CustomMaterials.getItem(CustomMaterials.Materials.IRIDIUM).TechType,
            4
        );
        addItemToRecipe(TechType.PrecursorIonPowerCell, TechType.MercuryOre, 2);
        addItemToRecipe(
            TechType.PrecursorIonPowerCell,
            CustomMaterials.getItem(CustomMaterials.Materials.VENT_CRYSTAL).TechType,
            5
        );
        ...
        addItemToRecipe(
            ...
            CraftingItems.getItem(CraftingItems.Items.DenseAzurite).TechType,
            1
        );
        ...
        addItemToRecipe(
            ...
            CustomMaterials.getIngot(CustomMaterials.Materials.IRIDIUM),
            hard ? 2 : 1
        );
        addItemToRecipe(
            TechType.RocketStage1,
            CustomMaterials.getIngot(CustomMaterials.Materials.PLATINUM),
            hard ? 3 : 2
        );
        addItemToRecipe(TechType.RocketStage1, C2CItems.getIngot(TechType.Diamond).ingot, hard ? 3 : 2);
        addItemToRecipe(
            TechType.RocketStage1,
            CraftingItems.getItem(CraftingItems.Items.Tungsten).TechType,
            hard ? 12 : 6
        );
        RecipeUtil.modifyIngredients(
        ...
        addItemToRecipe(
            TechType.RocketStage2,
            CraftingItems.getItem(CraftingItems.Items.Nanocarbon).TechType,
            hard ? 9 : 6
        );
        RecipeUtil.modifyIngredients(
            TechType.RocketStage3,
            i => {
                if (i.techType == TechType.EnameledGlass) {
                    i._amount = 5;
                    i._techType = obsidiglass.TechType;
                }
        ...
        var addMotors = new Dictionary<TechType, int>() {
        ...
        var replaceTableCoral = new Dictionary<TechType, int>() {
            { TechType.ComputerChip, 2 },
            { TechType.Fabricator, 1 },
            { TechType.BaseMapRoom, hard ? 2 : 1 },
        };

        foreach (var kvp in addMotors) {
            var amt = -1;
            RecipeUtil.modifyIngredients(
                kvp.Key,
                i => {
        ...
        foreach (var kvp in replaceTableCoral) {
            var amt = -1;
            RecipeUtil.modifyIngredients(
                kvp.Key,
                i => {
        ...
        addItemToRecipe(
            ...
            CustomMaterials.getItem(CustomMaterials.Materials.CALCITE).TechType,
            8
        );
        //1300m -> ILZ
        ...
        addItemToRecipe(
            ...
            comb.TechType,
            hard ? 2 : 1
        ); //down from 2 because of all the new stuff
        ...
        RecipeUtil.modifyIngredients(
            ...
            i => {
                if (i.techType == TechType.Glass) i._amount *= 2;
                return false;
            }
        );
        ...
        RecipeUtil.modifyIngredients(
            ...
            i => {
                if (i.techType == TechType.WiringKit) i._amount *= 2;
                return false;
            }
        );
        RecipeUtil.modifyIngredients(
            TechType.WiringKit,
            i => {
                if (i.techType == TechType.Silver) i._amount = 3;
                return false;
            }
        );
        ...
        RecipeUtil.addRecipe(TechType.PrecursorKey_Red, TechGroup.Personal, TechCategory.Equipment, ["Machines"]);
        ...
        RecipeUtil.addRecipe(TechType.PrecursorKey_White, TechGroup.Personal, TechCategory.Equipment, ["Machines"]);
        ...
        if (hard)
            RecipeUtil.addIngredient(
                TechType.Seamoth,
                TechType.EnameledGlass,
                RecipeUtil.removeIngredient(TechType.Seamoth, TechType.Glass).amount
            );
        ...
        addItemToRecipe(
            ...
            CraftingItems.getItem(CraftingItems.Items.DimLuminol).TechType,
            1
        );
        ...
        */
        ...
        foreach (var f in typeof(C2CItems).GetFields(
        ...
        foreach (var tt in specialRecipes)
            lockRecipe(tt);
    ...
    private static void addItemToRecipe(TechType tt, RecipeData td, TechType add, int amt = 1) {
    ...
    private static void createCompressedIngot(
        DIPrefab<VanillaResources> item,
        string pfbMdl,
        float specInt,
        float shiny,
        float fresnel,
        ...
        createCompressedIngot(
            ...
            shiny,
            fresnel,
            n.Substring(0, 1) + n.Substring(1).ToLowerInvariant(),
            amt,
            name,
            item.getIcon()
        );
    ...
    private static void createCompressedIngot(
        ...
        var pref = name[0] == 'A' || name[0] == 'E' || name[0] == 'I' || name[0] == 'O' || name[0] == 'U'
            ? "An "
            : "A ";
        var ingot = new BasicCraftingItem(
            "ingot_" + item,
            refName + " " + name,
            pref + name.ToLowerInvariant() + " of compressed " + refName.ToLowerInvariant() + ".",
            pfbMdl
        );
        ...
        ingot.sprite = TextureManager.getSprite(
            SeaToSeaMod.ModDLL,
            "Textures/Items/Ingot/" + refName.ToLowerInvariant()
        );
        ingot.renderModify = r => {
            ...
            if (item == TechType.Salt) {
                var root = r.gameObject.FindAncestor<PrefabIdentifier>().gameObject;
                var cg = root.EnsureComponent<SaltGrindable>();
                cg.techType =
                    C2CItems.getIngot(TechType.Salt).ingot; //fetch not use local var because patch() is not called yet
            ...
            var pi = r.gameObject.FindAncestor<PrefabIdentifier>();
        ...
        var unpack = new DuplicateRecipeDelegateWithRecipe(item, rec);
        unpack.craftTime = 3;
        ...
        unpack.craftingMenuTree = ["Resources", "C2CIngots2"];
    ...
    */
    ...
    private class LockedRecipeList : List<Ingredient> {
        public bool allowAdd { get; private set; }

        internal LockedRecipeList(RecipeData r, bool add = false) : base(r.Ingredients) {
            allowAdd = add;
        }

        private new void Add(Ingredient i) {
            if (allowAdd)
                base.Add(i);
            else
        ...
        private new void Insert(int idx, Ingredient i) {
            if (allowAdd)
                base.Insert(idx, i);
            else
                throw new Exception("Unsupported operation");
        ...
        private new void Remove(Ingredient i) {
            throw new Exception("Unsupported operation");
        }

        private new void RemoveAt(int idx) {
            throw new Exception("Unsupported operation");
        }
        ...
        public new Ingredient this[int index] {
            get => base[index];
            set => throw new Exception("Unsupported operation");
        }
    }
}