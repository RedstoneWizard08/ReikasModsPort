...
public class POITeleportSystem {
	...
	public static readonly POITeleportSystem instance = new();

	private readonly Dictionary<string, POI> data = new();
	...
	private class POI {
		...
		internal Action additionalActions;
