...
public class LiquidBreathingSystem {
	...
	internal static readonly float ITEM_VALUE = SeaToSeaMod.ModConfig.getBoolean(C2CConfig.ConfigEntries.HARDMODE) ? 1800 : 2700;
	//seconds
	...
	private float rechargingTintStrength;
	...
	public void updateOxygenGUI(uGUI_OxygenBar gui) {
		...
		if (pink && rechargingTintStrength > 0) {
			var f = 1 - 0.33F * (0.5F + rechargingTintStrength * 0.5F);
