...
public static class CraftingItems {
    ...
    public enum Items {
        [Item(
            typeof(BasicCraftingItem),
            TechCategory.AdvancedMaterials,
            TechType.AramidFibers,
            "WorldEntities/Natural/aerogel"
        )]
        HoneycombComposite,

        [Item(
            typeof(NotFabricable),
            TechCategory.AdvancedMaterials,
            TechType.Unobtanium,
            "WorldEntities/Natural/aerogel"
        )]
        ...
        [Item(
            ...
            TechType.Unobtanium,
            "WorldEntities/Natural/CrashPowder"
        )]
        Tungsten,
        ...
        [Item(
            ...
            TechCategory.AdvancedMaterials,
            TechType.Unobtanium,
            "WorldEntities/Natural/TwistyBridgesEgg"
        )]
        GhostGel,
        ...
        [Item(
            ...
            TechCategory.VehicleUpgrades,
            TechType.Unobtanium,
            "WorldEntities/Natural/hydrochloricacid"
        )]
        SulfurAcid,
        ...
        [Item(
            ...
            TechCategory.AdvancedMaterials,
            TechType.Unobtanium,
            "WorldEntities/Natural/EnameledGlass"
        )]
        CrystalLens,
        ...
        [Item(
            ...
            TechCategory.AdvancedMaterials,
            TechType.Unobtanium,
            "WorldEntities/Natural/Magnesium"
        )]
        HullPlating, //was wiring kit
        ...
        [Item(
            ...
            TechCategory.AdvancedMaterials,
            TechType.Unobtanium,
            "WorldEntities/Natural/aramidfibers"
        )]
        SealFabric,
        ...
        [Item(
            ...
            TechCategory.AdvancedMaterials,
            TechType.Unobtanium,
            "WorldEntities/Natural/FiberMesh"
        )]
        SmartPolymer,
        ...
        [Item(
            ...
            TechType.Lubricant,
            "WorldEntities/Natural/Lubricant"
        )]
        Motor,
        ...
        [Item(
            ...
            TechCategory.Electronics,
            TechType.Unobtanium,
            "WorldEntities/Natural/WiringKit"
        )]
        LathingDrone,
        ...
        [Item(
            ...
            "WorldEntities/Natural/Silicone"
        )]
        FuelTankWall,
        ...
        [Item(
            ...
            TechCategory.VehicleUpgrades,
            TechType.Kyanite,
            "WorldEntities/Natural/benzene"
        )]
        RocketFuel,

        [Item(typeof(NotFabricable), TechCategory.Misc, TechType.Unobtanium, "WorldEntities/Tools/Battery")]
        BrokenT2Battery,

        [Item(typeof(NotFabricable), TechCategory.Misc, TechType.Unobtanium, "WorldEntities/Seeds/CreepvinePiece")]
        AmoeboidSample,
