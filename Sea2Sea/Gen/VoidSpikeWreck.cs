...
public sealed class VoidSpikeWreck : WorldGenerator {
    ...
    static VoidSpikeWreck() {
        ...
        pieces.Add(
            new VoidWreckProp("68462082-f714-4b5e-8d0d-623d2ec6058f", new float[] { 0, 180 }, 0.25F)
        ); //broken seaglide
        pieces.Add(
            new VoidWreckProp("0cb9b6b4-5f39-49f2-821e-6490829dad4b", new float[] { 0, 180 }, 0.25F)
        ); //broken terraformer
        //pieces.Add(new Prop()); //storage cube
        //pieces.Add(new Prop("12c95e66-fb54-47b3-87f1-8e318394b839", null, 0.1F));	//flashlight
        pieces.Add(
            new VoidWreckProp("7c1aa35f-759e-4861-a871-f58843698298", new float[] { 0, 180 }, 0.2F)
        ); //broken stasis rifle
        ...
        pieces.Add(
            new VoidWreckProp("f4146f7a-d334-404a-abdc-dff98365eb10", new float[] { -90, 90 }, 0.2F)
        ); //broken transfuser
        ...
        DICustomPrefab pfb = new DICustomPrefab(id);
    ...
    public override bool generate(List<GameObject> li) {
        ...
        pda.transform.position = this.getPDALocation();
        ...
        foreach (VoidWreckProp s in pieces) {
            li.Add(this.generateObjectInRange(refPos, 3.5F, s));
        }
    ...
    private GameObject generateObjectInRange(Vector3 refPos, float r, VoidWreckProp p) {
        ...
        return this.generateObjectInRange(
            refPos,
            r,
