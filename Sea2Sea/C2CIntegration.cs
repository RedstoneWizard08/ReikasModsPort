...
public static class C2CIntegration {
    ...
    public static void injectConfigValues() {
        ...
        AuroresourceMod.ModConfig.attachOverride(ARConfig.ConfigEntries.REENTRY_WARNING, f => Mathf.Clamp(f, 0.5F, 4F));
        AuroresourceMod.ModConfig.attachOverride(ARConfig.ConfigEntries.GEYSER_RESOURCE_RATE, 1.5F);

        AqueousEngineeringMod.config.attachOverride(
            AEConfig.ConfigEntries.POO_RATE,
            f => Mathf.Clamp(f, 0.25F, hard ? 3F : 4F)
        );
        ...
        AqueousEngineeringMod.config.attachOverride(
            AEConfig.ConfigEntries.PILLARLIM,
            f => Mathf.Clamp(f, 1, hard ? 1 : 2)
        );
        ...
        EcoceanMod.config.attachOverride(
            ECConfig.ConfigEntries.GLOWFIRERATE,
            f => hard ? Mathf.Clamp(f, 0.33F, 0.67F) : Mathf.Clamp(f, 0.75F, 1F)
        );
        ...
        EcoceanMod.config.attachOverride(
            ECConfig.ConfigEntries.GLOBALCOMPASS,
            f => Mathf.Clamp(f, hard ? 0.75F : 0.25F, 1F)
        );
    ...
    public static void prePostAdd() {
        BaseDrillableGrinder.uncraftingIngredientRatios
            [CraftingItems.getItem(CraftingItems.Items.Nanocarbon).TechType] = 1;
        BaseDrillableGrinder.uncraftingIngredientRatios
            [CraftingItems.getItem(CraftingItems.Items.TraceMetals).TechType] = 1;
        BaseDrillableGrinder.uncraftingIngredientRatios[CraftingItems.getItem(CraftingItems.Items.GeyserMinerals)
            .TechType] = 1;
        BaseDrillableGrinder.uncraftingIngredientRatios[
            CraftingItems.getItem(CraftingItems.Items.Electrolytes).TechType] = 1;
        BaseDrillableGrinder.uncraftingIngredientRatios[CraftingItems.getItem(CraftingItems.Items.Tungsten).TechType] =
            1;
        ...
        BaseDrillableGrinder.uncraftabilityFlags[CraftingItems.getItem(CraftingItems.Items.TraceMetals).TechType] =
            false;
        BaseDrillableGrinder.uncraftabilityFlags[CraftingItems.getItem(CraftingItems.Items.WeakEnzyme42).TechType] =
            false;
    ...
    public static void addPostCompat() {
        ...
        var rec = Bioprocessor.getRecipe(TechType.SeaTreaderPoop);
        Bioprocessor.addRecipe(
            new TypeInput(AqueousEngineeringMod.poo),
            CraftingItems.getItem(CraftingItems.Items.TreaderEnzymes).TechType,
            rec.enzyCount,
            rec.processTime,
            rec.totalEnergyCost,
            rec.inputCount * 4,
        ...
        var glassForest = new BiomeRegions.RegionType(
            "GlassForest",
            UnderwaterIslandsFloorBiome.instance.DisplayName,
            3.5F,
            0F,
            0.8F,
            0.85F
        ...
        var sanctuary = new BiomeRegions.RegionType(
            "Sanctuary",
            CrashZoneSanctuaryBiome.instance.DisplayName,
            0.1F,
            1.1F,
            0.85F,
            0.8F
        );
        AcuTheming.SetFloorTexture(
            glassForest,
            TextureManager.getTexture(SeaToSeaMod.ModDLL, "Textures/ACUFloor/GlassForest")
        );
        ...
        AcuTheming.SetFloorTexture(
            sanctuary,
            TextureManager.getTexture(SeaToSeaMod.ModDLL, "Textures/ACUFloor/Sanctuary")
        );
        ...
        if (hard)
            RecipeUtil.addIngredient(
                ...
                AqueousEngineeringMod.ionRod.TechType,
                RecipeUtil.removeIngredient(TechType.RocketStage3, TechType.ReactorRod).amount
            );
        ...
        RecipeUtil.addIngredient(
            CraftingItems.getItem(CraftingItems.Items.RocketFuel).TechType,
            EcoceanMod.glowOil.TechType,
            3
        );
        ...
        FinalLaunchAdditionalRequirementSystem.instance.addRequiredItem(
            EcoceanMod.lavaShroom.seed.TechType,
            2,
            "Flora adapted for and frequently becoming sources of extreme heat"
        );
        ...
        FinalLaunchAdditionalRequirementSystem.instance.addRequiredItem(
            EcoceanMod.pinkLeaves.seed.TechType,
            1,
            "A vibrantly pink plant almost wiped out by the aurora's impact"
        );
        ...
        RecipeUtil.addIngredient(
            ...
            CraftingItems.getItem(CraftingItems.Items.Motor).TechType,
            1
        );
        GenUtil.registerWorldgen(
            new PositionedPrefab(
                GenUtil.getOrCreateDatabox(EcoceanMod.planktonScoop.TechType).ClassID,
                new Vector3(332.93F, -277.64F, -1435.6F)
            )
        );

        RecipeUtil.addIngredient(
            AuroresourceMod.MeteorDetector.TechType,
            CraftingItems.getItem(CraftingItems.Items.DenseAzurite).TechType,
            1
        );
        RecipeUtil.addIngredient(
        ...
        RecipeUtil.addIngredient(
            CraftingItems.getItem(CraftingItems.Items.BacterialSample).TechType,
            EcoceanMod.planktonItem.TechType,
            1
        );
        ...
        RecipeUtil.addIngredient(
            AqueousEngineeringMod.wirelessChargerBlock.TechType,
            CraftingItems.getItem(CraftingItems.Items.GeyserMinerals).TechType,
            3
        );
        ...
        ItemDisplay.setRendererBehavior(
            CraftingItems.getItem(CraftingItems.Items.LathingDrone).TechType,
            new ItemDisplayRenderBehavior() {
                verticalOffset = 0.3F,
                getRenderObj =
                    ItemDisplayRenderBehavior.getChildNamed("model/" + CraftingItems.LATHING_DRONE_RENDER_OBJ_NAME),
            }
        );
        ItemDisplay.setRendererBehavior(
            CraftingItems.getItem(CraftingItems.Items.CrystalLens).TechType,
            new ItemDisplayRenderBehavior() { verticalOffset = 0.2F }
        );
        ItemDisplay.setRendererBehavior(
            CraftingItems.getItem(CraftingItems.Items.RocketFuel).TechType,
            TechType.Benzene
        ...
        ItemDisplay.setRendererBehavior(
            CraftingItems.getItem(CraftingItems.Items.WeakAcid).TechType,
            TechType.HydrochloricAcid
        );
        ItemDisplay.setRendererBehavior(
            CraftingItems.getItem(CraftingItems.Items.SulfurAcid).TechType,
            TechType.HydrochloricAcid
        );
        ItemDisplay.setRendererBehavior(
            CraftingItems.getItem(CraftingItems.Items.Sealant).TechType,
            TechType.Polyaniline
        );
        ItemDisplay.setRendererBehavior(
            CraftingItems.getItem(CraftingItems.Items.BioEnzymes).TechType,
            TechType.Polyaniline
        );
        ItemDisplay.setRendererBehavior(
            CraftingItems.getItem(CraftingItems.Items.KelpEnzymes).TechType,
            TechType.Polyaniline
        );
        ItemDisplay.setRendererBehavior(
            CraftingItems.getItem(CraftingItems.Items.TreaderEnzymes).TechType,
        ...
        ItemDisplay.setRendererBehavior(
            CraftingItems.getItem(CraftingItems.Items.Chlorine).TechType,
            TechType.Polyaniline
        );
        ItemDisplay.setRendererBehavior(
            CraftingItems.getItem(CraftingItems.Items.Luminol).TechType,
            TechType.Polyaniline
        );
        ...
        CompassDistortionSystem.instance.addRegionalDistortion(
            new CompassDistortionSystem.BiomeDistortion(UnderwaterIslandsFloorBiome.instance, 180F, 0.18F)
        );
        CompassDistortionSystem.instance.addRegionalDistortion(
            new CompassDistortionSystem.ConditionalDistortion(
                pos => VoidSpikeLeviathanSystem.instance.isVoidFlashActive(true),
                720F,
                1.2F
            )
        );
        ...
        FoodEffectSystem.instance.addDamageOverTimeEffect(
            C2CItems.mountainGlow.seed.TechType,
            50,
            30,
            DamageType.Heat,
            SeaToSeaMod.ItemLocale.getEntry(C2CItems.mountainGlow.ClassID).getString("eateffect")
        );
        ...
        FoodEffectSystem.instance.addDamageOverTimeEffect(
            C2CItems.alkali.seed.TechType,
            75,
            30,
            DamageType.Acid,
            SeaToSeaMod.ItemLocale.getEntry(C2CItems.alkali.ClassID).getString("eateffect")
        );
        ...
        BaseRoomSpecializationSystem.instance.setDisplayValue(
            C2CItems.purpleBoomerang.TechType,
            0.3F
        ); //lava boomerang is 0.25
        ...
        BaseRoomSpecializationSystem.instance.setDisplayValue(
            CustomMaterials.getItem(CustomMaterials.Materials.OXYGENITE).TechType,
            1.25F
        );
        ...
        foreach (var ingot in C2CItems.getIngots())
            BaseRoomSpecializationSystem.instance.setDisplayValue(
                ingot.ingot,
                BaseRoomSpecializationSystem.instance.getItemDecoValue(ingot.material) * ingot.count / 2F
            );

        MoraleSystem.instance.registerBiomeEffect(VoidSpikesBiome.instance).setEnv(0, -10)
            .setEnv(-0.5F, -20, EnvContext.FREEDIVE).setEnv(-5, -100, EnvContext.CYCLOPS);
        MoraleSystem.instance.registerBiomeEffect(UnderwaterIslandsFloorBiome.instance).setEnv(0, -5)
            .setEnv(0, 0, EnvContext.SEABASE);
        MoraleSystem.instance.registerBiomeEffect(CrashZoneSanctuaryBiome.instance).setEnv(0.25F, 10)
            .setEnv(0.5F, 20, EnvContext.FREEDIVE).setEnv(0, 20, EnvContext.SEABASE);

        foreach (var s in SeaToSeaMod.LrCoralClusters)
        ...
        Type t;
        if (EnumHandler.TryGetValue("ResourceMonitorBuildableSmall", out TechType tt)) {
            RecipeUtil.modifyIngredients(tt, cheapenResourceMonitor);
            RecipeUtil.addIngredient(tt, TechType.AluminumOxide, 1);
        }

        if (EnumHandler.TryGetValue("ResourceMonitorBuildableLarge", out tt)) {
            RecipeUtil.modifyIngredients(tt, cheapenResourceMonitor);
            ...
            InstructionHandlers.patchMethod(
                ...
                SeaToSeaMod.ModDLL,
                filterStorageContainerInteract
            );
        }
        ...
        if (t != null) {
            ...
            var settingMain = t.GetProperty(
                "Settings",
                BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Static
            ).GetValue(null);
            settingMain.GetType().GetField(
                "autoCraft",
                BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance
            ).SetValue(settingMain, false);
        }

        if (EnumHandler.TryGetValue("TechPistol", out tt)) {
        ...
        ItemUnlockLegitimacySystem.instance.add(
            "TechPistol",
            "TechPistol",
            () => Story.StoryGoalManager.main.completedGoals.Contains("Iridium")
        );

        if (EnumHandler.TryGetValue("SeamothDrillArmModule", out tt)) {
        ...
        if (EnumHandler.TryGetValue("SeamothPropulsionArmModule", out tt)) {
            ...
            InstructionHandlers.patchMethod(
                ...
                codes => {
                    var idx = InstructionHandlers.getInstruction(
                        ...
                        0,
                        OpCodes.Stsfld,
                        "SlotExtender.Configuration.SEConfig",
                        "MAXSLOTS"
                    );
                    codes.InsertRange(
                        idx,
            ...
            RecipeUtil.modifyIngredients(
                ...
                i => {
                    if (i.techType == TechType.TitaniumIngot) {
                        i._techType = TechType.PlasteelIngot;
                    } else if (i.techType == TechType.Glass) {
                        i._amount *= 3;
                    } else if (i.techType == TechType.Lubricant) {
                        i._techType = CraftingItems.getItem(CraftingItems.Items.Motor).TechType;
                        i._amount *= 5;
                    } else if (i.techType == TechType.WiringKit) {
                        i._techType = TechType.AdvancedWiringKit;
                        i._amount *= 2;
                    }
    ...
    private static bool cheapenResourceMonitor(Ingredient i) {
        ...
        if (i.techType == TechType.AdvancedWiringKit)
            i._techType = TechType.WiringKit;
        return false;
    }
}