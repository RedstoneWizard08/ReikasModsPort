...
public class VoidSpikeLeviathan : CreatureAsset {
    ...
    */
    public override CreatureAsset.SmallVehicleAggressivenessSettings AggressivenessToSmallVehicles {
        get { return new CreatureAsset.SmallVehicleAggressivenessSettings(1F, 440F); }
    }
    ...
    public override CreatureAsset.BehaviourLODLevelsStruct BehaviourLODSettings {
        get { return new CreatureAsset.BehaviourLODLevelsStruct(600, 999, 999); }
    }
    ...
    public override CreatureAsset.AvoidObstaclesData AvoidObstaclesSettings {
        get { return new CreatureAsset.AvoidObstaclesData(0.2F, false, 25); }
    }
    ...
    public override ScannableItemData ScannableSettings {
        get {
            ...
            return new ScannableItemData(
                ...
                path.Split('/'),
                null,
                TextureManager.getTexture(SeaToSeaMod.modDLL, "Textures/PDA/" + locale.getString("header"))
            );
        }
    }
    ...
    internal class VoidSpikeLeviathanAI : MonoBehaviour {
        ...
        void Update() {
            ...
            } else if (time >= nextPossibleBurstTime && this.canStartAPulse() &&
                       UnityEngine.Random.Range(0F, 1F) <= 0.01F * creatureClass.Aggression.Value) {
            ...
            if (this.isEMPInProgress()) {
                targetEmissivity = Mathf.Max(
                    0,
                    (empRamp * 4F) + UnityEngine.Random.Range(0F, 2.5F) + (4F * Mathf.Sin(empRamp * 8))
                );
            } else if (this.isFlashInProgress()) {
                targetEmissivity = Mathf.Max(
                    0,
                    flashRamp * flashRamp * 50 * UnityEngine.Random.Range(0, 1F) /*+0.5F+15F*Mathf.Sin(flashRamp*50)*/
                );
            }
        ...
        internal void startEMP() {
            ...
            nextPossibleBurstTime =
                DayNightCycle.main.timePassedAsFloat + UnityEngine.Random.Range(30, isDebug ? 31 : 90);
        }
        ...
        internal void startFlash() {
            ...
            nextPossibleBurstTime =
                DayNightCycle.main.timePassedAsFloat + UnityEngine.Random.Range(60, isDebug ? 90 : 120);
        }
        ...
        internal bool canStartAPulse() {
            return !this.isFlashInProgress() && !this.isEMPInProgress() &&
