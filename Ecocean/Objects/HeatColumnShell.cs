    ...
    public override GameObject GetGameObject() {
        GameObject
            world = GameObject.CreatePrimitive(PrimitiveType.Cylinder)
                ...
                ); // ObjectUtil.createWorldObject("42b38968-bd3a-4bfd-9d93-17078d161b29").setName(ClassID+"[Clone]");
...
public class HeatColumnShellTag : MonoBehaviour {
    ...
    private void Update() {
        ...
        render.materials[0].SetTexture(
            "_SpecTex",
            TextureManager.getTexture(EcoceanMod.modDLL, "Textures/heatcolumnshell")
        );
